	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
	{
		...
		else
		{
			...
			else if (submit.equals(MATCHES) || submit.equals(FINISH))
			{
				...
				System.out.println("StatePages= " +pageNumber +" | SurveyPageNumber= " +_survey.getNumPages() +". \n");
				...
				{
					userState.setStartPageNumber(0); //set page number to 0 an error or malicious user
